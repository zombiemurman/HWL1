...
namespace Assets._Project.Develop.Runtime.Gameplay.Features.Attack.Shoot
{
    public class InstantShootForwardSystem : IInitializableSystem, IDisposableSystem
    {
        ...
        public InstantShootForwardSystem(EntitiesFactory entitiesFactory)
        {
        ...
        {
            _entitiesFactory.CreateProjectileHero(_shootPoint.position, _shootPoint.forward, _damage.Value);
        }
    }
}
